...
public class ProfileReviewsFragment extends Fragment implements PostListAdapter.ItemClickListener{
    ...
    public void onItemClick(View view, int position) {
        ...
        navController.navigate(R.id.action_profileReviewsFragment_to_navigation_post, bundle);
    }
