...
public class PostsList extends Fragment implements PostListAdapter.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(view == null) {
            this.view = inflater.inflate(R.layout.fragment_location_posts, container, false);
    ...
    public void onItemClick(View view, int position) {
        ...
        navController.navigate(R.id.action_postsList_to_navigation_post, bundle);
